/**
 * @file  Parser for constraint programming language Essence, for use with block editor Conjure-Blocks
 * @author Nadine Martin, Jamie Melton, Leia Young <nm275@st-andrews.ac.uk>
 * @license MIT
 */
...
export default grammar({
  ...
  rules: {
    //top-level statements
        ...
        variable_list: $ => seq($.variable, repeat(seq(
            ",",
            $.variable
        ))),
        ...
        range_list: $ => seq(choice($.int_range, $.integer), repeat(seq(",", choice($.int_range, $.integer)))),
        ...
        //constraints
        constraint_list: $ => prec(20, seq("such that", $.expr_list)),
        // separated out for
        ...
        expr_list: $ => prec.left(30, seq($.expression, repeat(seq(",",
            $.expression,
       ...
       /* muliplicative: $ => prec(3,choice(
            $.product_expr,
            $.multiplicative_op
        )),
    
        additive: $ => prec(3,choice(
            $.additive_op,
            $.sum_expr
        )),*/
